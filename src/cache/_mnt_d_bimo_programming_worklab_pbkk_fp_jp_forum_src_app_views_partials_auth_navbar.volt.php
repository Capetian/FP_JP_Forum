<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ml-3">
      <li class="nav-item active">
        <a class="nav-link" href="<?= $this->url->get('/user/show/') . $this->session->get('auth')['uid'] ?>" ><?= $this->session->get('auth')['username'] ?><span class="sr-only"></span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= $this->url->get('/index/logout') ?>">Logout</a>
      </li>
    </ul>
  </div>
</nav>